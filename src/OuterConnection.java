public class OuterConnection {
    ...
    public OuterConnection(int group_connection_id, int group_connection_node_id){
        this.group_connection_id = group_connection_id;
        this.group_connection_node_id = group_connection_node_id;
    }

    public void setGroup_connection_id(int group_connection_id){
        this.group_connection_id = group_connection_id;
    }

    public int getGroup_connection_id(){
